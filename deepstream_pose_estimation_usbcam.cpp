...
int main(int argc, char *argv[])
{
  ...
  GMainLoop *loop = NULL;
  GstCaps *caps = NULL;
  GstElement *source = NULL, *vidconv_src = NULL, *nvvidconv_src = NULL, *filter_src = NULL, *h264parser = NULL,
...
/* Add a transform element for Jetson*/
  ...
  printf("2\n");
  /*if (!source || !vidconv_src || !nvvidconv_src || !filter_src || !pgie || !nvvidconv || !nvosd || !sink || !cap_filter || !tee || !nvvideoconvert ||
